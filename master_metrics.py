...
def compute_metrics(cosine_sim_matrix, ground_truth):
    ...
    mean_rank, median_rank = calculate_mean_median_rank(cosine_sim_matrix, ground_truth)
...
if __name__ == "__main__":
    ...
    mnr, mdr = calculate_mean_median_rank(cosine_sim_matrix, ground_truth)
    print(f"Mean: {round(mnr, 2)} \t Median: {mdr}")
